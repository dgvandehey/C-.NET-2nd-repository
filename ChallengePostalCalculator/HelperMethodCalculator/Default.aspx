<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HelperMethodCalculator.Default" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:RadioButton ID="dayRadioButton" runat="server" AutoPostBack="True" GroupName="methodGroup" OnCheckedChanged="dayRadioButton_CheckedChanged" Text="Next Day" />
        <br />
        <br />
